...
<head>
	...
	<title>Agência Marketing Digital</title>
...
<body>
	...
	<section class="descricao-danki">
		<div class="container">
			<p>Com anos de experiência em desenvolvimento web e automação de marketing, a <b>Max-Tech</b> traz soluções que ajudam o seu time a vender mais tanto em seguimentos B2C quanto B2B.</p>
		</div>
	</section>
	...
	<footer>
		<div class="container">
			<div class="box-footer">
				<h2>Endereço</h2>
				<p>Rua Osvaldo de Andrade, 447 - Centro, Planalto/BA, 45190-000, Brasil</p>
			</div>
			...
			<div class="media-social">
				<a target="_blank" href="https://www.instagram.com/mrmarcos_mribeiro/"><i class="fa fa-instagram"></i></a>
				<a href=""><i class="fa fa-facebook"></i></a>
				<a target="_blank" href="https://www.linkedin.com/in/marcos-ribeiro-9243b1232/"><i class="fa fa-linkedin"></i></a>
				<a target="_blank" href="https://github.com/marcosmmribeiro"><i class="fa fa-github"></i></a>
			</div>
		</div>	
	</footer>
